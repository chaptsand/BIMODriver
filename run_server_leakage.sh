...
# Evaluates BIMODriver, DISFusion, and MNGCL across 10 runs with early checkpointing
# ==============================================================================
...
echo "========================================================================"
echo "Step 1/2: Running DISFusion on Clean <-> Hit splits (Paper Setting)..."
...
echo "========================================================================"
echo "Step 2/2: Running MNGCL on Clean <-> Hit splits (Paper Setting)..."
echo "  - Features: 64-dim (48 omics + 16 topology)"
