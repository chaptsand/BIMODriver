# -*- coding: utf-8 -*-
"""Network architecture for the Table A16 BERT-base variant.

The architecture is intentionally identical to the original model. Table A16
changes only the pretrained language model used to create semantic features.
"""
import numpy as np
import pandas as pd
import time
